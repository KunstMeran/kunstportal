...
-- 4. Daten migrieren (boolean true -> 'write', false -> 'none')
...
SELECT
    ...
    CASE MAX(CASE w.access_inventar WHEN 'write' THEN 2 WHEN 'read' THEN 1 ELSE 0 END)
        WHEN 2 THEN 'write' WHEN 1 THEN 'read' ELSE 'none' END::permission_level as access_inventar,
...
COMMENT ON COLUMN workspaces.access_inventar IS '3-stufige Berechtigung für Inventar: none/read/write';
